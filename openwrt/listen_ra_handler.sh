...
# Last modified: Tue Jun 11 14:24:08 2013 mstenber
# Edit time:     19 min
#
...
start() {
    ...
    # According to RFC6204, we're supposed to be host on the link,
    # so run normal address assignment there based on router advertisements
